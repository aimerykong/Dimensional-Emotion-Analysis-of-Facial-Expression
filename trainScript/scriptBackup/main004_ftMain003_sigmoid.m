...
netbasemodel.params(netbasemodel.getParamIndex('conv7_f')).learningRate = 5;
netbasemodel.params(netbasemodel.getParamIndex('conv7_b')).learningRate = 5;
...
opts.expDir = fullfile('./exp', 'main004_ftMain003_sigmoid');
