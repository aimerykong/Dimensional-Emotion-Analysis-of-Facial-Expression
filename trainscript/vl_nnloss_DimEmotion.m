function y = vl_nnloss_DimEmotion(x,c,dzdy,varargin)
...
switch lower(opts.loss)
    ...
    case {'binaryerror', 'binarylog', 'logistic', 'hinge', 'depthregloss', 'reg_l1', 'reg_l2'}        
...
if nargin <= 2 || isempty(dzdy)
    ...
    switch lower(opts.loss)
        ...
        case 'softmaxlog'
            ...
            ci = unique(ci);  % CUDA execution problem -- not unique values in large input
            y(ci) = y(ci) - 1 ;
