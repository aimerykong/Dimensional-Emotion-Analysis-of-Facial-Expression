function net = init_resADE20k_ChaAtten_withScaleAttentionModule(n, insertBlockList, moduleStruct , varargin)
...
switch n
    ...
    case {50, 101, 152}
        %% conv1
        %         block = dagnn.Conv('size',  [7 7 3 64], 'hasBias', false, 'stride', 2, 'pad', [3 3 3 3]);
        %         lName = 'conv1';
