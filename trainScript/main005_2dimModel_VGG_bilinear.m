...
modelName = 'DimEmotion_resnet_L1_net-epoch-500.mat'; % 497
...
output_f = netbasemodel.params(netbasemodel.getParamIndex('output_f')).value;
output_b = netbasemodel.params(netbasemodel.getParamIndex('output_b')).value;
...
opts.expDir = fullfile('./exp', 'main014_2dimModel_vgg16_v2_bilinear');
