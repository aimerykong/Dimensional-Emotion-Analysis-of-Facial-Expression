...
output_f = netbasemodel.params(netbasemodel.getParamIndex('block6_conv_f')).value;
output_b = netbasemodel.params(netbasemodel.getParamIndex('block6_conv_b')).value;
...
opts.expDir = fullfile('./exp', 'main015_2dimModel_res50_v1_forward');
