...
modelName = 'DimEmotion_resnet_L1_net-epoch-439.mat'; % 245
...
netbasemodel.removeLayer('block6_output');
netbasemodel.removeLayer('block6_dropout');
netbasemodel.removeLayer('pool5_7x7_s1');
netbasemodel.removeLayer('conv5_3_relu');
netbasemodel.removeLayer('conv5_3');
netbasemodel.removeLayer('conv5_3_1x1_increase_bn');
netbasemodel.removeLayer('conv5_3_1x1_increase');


% conv5_3_3x3
% conv5_3_3x3_bn
% conv5_3_3x3_bnxx
sName = 'conv5_3_3x3_bnxx';
...
opts.expDir = fullfile('./exp', 'main013_vggface2_bilinear_v1');
