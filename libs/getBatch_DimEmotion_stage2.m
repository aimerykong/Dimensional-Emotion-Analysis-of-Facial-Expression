function [imBatch, labelBatch] = getBatch_DimEmotion_stage2(imdb, batch, mode, opts)
% -------------------------------------------------------------------------

imBatch = zeros(imdb.meta.imagesize(1),imdb.meta.imagesize(2), 1, length(batch),'single');
